...
# API_TOKEN = '5844427862:AAG0TwhGifTxt-vNrXCs8cK6YsbMu2vQ_1M'
#
...
if __name__ == '__main__':
    message = """#сниму 
Всем привет! Сниму 1-2 комнатную квартиру с отдельной спальней на полгода-год. 
Молодая семья, с взрослой воспитанной, спокойной небольшой кошкой (которая постоянно спит, будем рады  прописать отдельным пунктом в договоре для вашего спокойствия).
Центральное отопление, солнечная сторона (в идеале). 
Бюджет 500-600$, можно 650$ (если включены к/у)."""
